...
// ==/UserScript==
const linksarray = ["index.php","item.php","city.php","jobs.php","gym.php","properties.php","education.php",
                    "crimes.php","loader.php?sid=missions","newspaper.php","jailview.php","hospitalview.php",
                    "casino.php","halloffame.php","factions.php","bringafriend.php","competition.php",
                    "friendlist.php","blacklist.php","messages.php","events.php","awards.php","points.php","rules.php",
                    "staff.php","credits.php","citystats.php","committee.php","bank.php","donator.php","stockexchange.php",
...
window.addEventListener('load', function() {
    ...
    var randomLink = homenav.cloneNode(true);
    randomLink.id = 'easterrandom';

    var href = randomLink.firstChild.firstChild;
    ...
    href.insertAdjacentHTML('afterbegin', easterspans);
...
let randoLink = linksarray[Math.floor(Math.random() * linksarray.length)];
